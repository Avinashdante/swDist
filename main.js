...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.addNewCompany = function () {
        var control = this.myForm.controls.companies;
        control.push(this.fb.group({
            company: [''],
            projects: this.fb.array([])
        }));
    };
    AppComponent.prototype.deleteCompany = function (index) {
        var control = this.myForm.controls.companies;
        control.removeAt(index);
    };
    AppComponent.prototype.addNewProject = function (control) {
        control.push(this.fb.group({
            projectName: ['']
        }));
    };
    AppComponent.prototype.deleteProject = function (control, index) {
        control.removeAt(index);
    };
    AppComponent.prototype.setCompanies = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new Promise(function (res, rej) {
                            _this.http.get("https://raw.githubusercontent.com/Avinashdante/sw/master/datFile").subscribe(function (data) {
                                _this.data = data;
                    ...
                    case 1:
                        _a.sent();
                        control = this.myForm.controls.companies;
                        console.log(this.data);
                        this.data.companies.forEach(function (x) {
                            control.push(_this.fb.group({
                                company: x.company,
                                projects: _this.setProjects(x)
                            }));
                        });
                        return [2 /*return*/];
                }
    ...
    AppComponent.prototype.setProjects = function (x) {
        var _this = this;
        var arr = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormArray"]([]);
        x.projects.forEach(function (y) {
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"]],
...
module.exports = __webpack_require__(/*! W:\sw\src\main.ts */"./src/main.ts");
